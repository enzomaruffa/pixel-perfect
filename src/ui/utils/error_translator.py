...
def translate_error(error: Exception, context: Optional[str] = None) -> Dict[str, Any]:
...
def translate_validation_error(error: ValidationError, context: Optional[str] = None) -> Dict[str, Any]:
    ...
    if error_type == "literal_error":
        ...
        return {
            ...
            "suggestion": f'Did you mean "{suggestion}"?' if suggestion else "Please select a valid option",
            "field": field,
        ...
        return {
            "message": f'{field.title()} value {input_value} is outside valid range',
...
def translate_processing_error(error: Exception, context: Optional[str] = None) -> Dict[str, Any]:
    ...
    # Image format errors
    if "image" in error_str.lower() and ("format" in error_str.lower() or "mode" in error_str.lower()):
        return {
...
def translate_file_error(error: FileNotFoundError, context: Optional[str] = None) -> Dict[str, Any]:
...
def translate_value_error(error: ValueError, context: Optional[str] = None) -> Dict[str, Any]:
...
def translate_type_error(error: TypeError, context: Optional[str] = None) -> Dict[str, Any]:
...
def suggest_closest_match(value: str, options: list) -> Optional[str]:
